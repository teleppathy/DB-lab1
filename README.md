...
#Зміст 
- [Короткий виклад вимог](#1-короткий-виклад-вимог)
- [Список сутностей та їх атрибутів](#2-список-сутностей-та-їх-атрибутів)
- [Пояснення зв'язків](#3-пояснення-зв'язків)
- [Припущення та обмеження](#4-припущення-та-обмеження)
